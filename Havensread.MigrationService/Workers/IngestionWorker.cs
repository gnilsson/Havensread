...
public sealed class IngestionWorker : WorkerBase<IngestionDbContext>
{
    public const string ActivitySourceName = "Ingestion Migrations";

    private readonly IServiceProvider _serviceProvider;

    public IngestionWorker(IServiceProvider serviceProvider) : base(serviceProvider, ActivitySourceName)
    {
