...
public sealed class AppMigrationWorker : MigrationWorkerBase<AppDbContext>
{
    public const string ActivitySourceName = "App Migrations";

    public AppMigrationWorker(IServiceProvider serviceProvider) : base(serviceProvider, ActivitySourceName)
    { }
